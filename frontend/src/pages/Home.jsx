        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 h-full flex items-center">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-2xl">
            <motion.div variants={fadeUp} custom={0} className="mb-6">
              <span className="text-white/90 text-[12px] font-bold tracking-[0.4em] uppercase">LocalStyle — La Sélection</span>
            </motion.div>
            ...
            <motion.div variants={fadeUp} custom={2} className="flex gap-6 items-center">
              <Link to="/shops" className="bg-white text-text-dark px-10 py-4 text-[12px] font-bold uppercase tracking-[0.2em] hover:bg-green hover:text-white transition-colors duration-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
            {[
              ...
              <motion.div key={item.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex flex-col items-center text-center space-y-4">
                ...
                <h4 className="text-[12px] font-black uppercase tracking-[0.4em] text-text-dark">{item.title}</h4>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div className="space-y-4">
              <span className="text-[12px] text-green uppercase tracking-[0.5em] font-black italic">La Sélection</span>
            ...
            <Link to="/shops" className="text-[12px] font-bold uppercase tracking-[0.2em] text-text-light hover:text-green transition-colors border-b border-border pb-1">
      ...
      <section className="py-32 bg-card border-y border-border">
        <div className="container mx-auto px-6 md:px-12">
          <div className="text-center mb-20 space-y-4">
            <span className="text-[12px] text-text-light uppercase tracking-[0.5em] font-bold">L'Art de Vivre</span>
                  ...
                  <Link to={`/product/${product.id}`} className="group block">
                    <div className="relative aspect-[4/5] overflow-hidden bg-white mb-6">
                      ...
                      <div className="absolute bottom-4 left-4">
                        <span className="bg-white/90 backdrop-blur-sm text-text-dark px-4 py-2 text-[12px] font-bold uppercase tracking-widest shadow-sm">
                          {product.price}€
                        </span>
                      </div>
                    </div>
                    <div className="space-y-1">
                      <p className="text-[11px] text-text-light uppercase tracking-[0.2em] font-medium">{product.category}</p>
          ...
          <div className="mt-20 text-center">
            <Link to="/catalogue" className="inline-block px-12 py-5 border border-border text-[12px] font-black uppercase tracking-[0.3em] hover:bg-text-dark hover:text-white transition-colors duration-200">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="text-center mb-20 space-y-4">
            <motion.span 
              ...
              viewport={{ once: true }}
              className="text-[12px] text-green uppercase tracking-[0.5em] font-black italic"
            >
              ...
              >
                ...
                <div className="flex flex-col items-start space-y-6">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-[12px] font-black uppercase tracking-[0.3em] text-text-dark">
                      {service.title}
                    </h3>
            ...
            <div className="inline-block bg-card border border-border p-8">
              <div className="flex items-center gap-8">
                <div className="text-left space-y-2">
                  <p className="text-[11px] text-text-light uppercase tracking-[0.4em] font-bold">
                    Livraison offerte
                  </p>
          ...
          <div className="relative bg-stone-900 dark:bg-black min-h-[500px] flex items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 w-full relative z-10">
              <div className="lg:col-span-3 p-12 md:p-24 space-y-10 text-left">
                <div className="space-y-4">
                  <span className="text-[12px] text-green uppercase tracking-[0.6em] font-black">Partenariat Privé</span>
                ...
                <div className="flex flex-col sm:flex-row gap-8 pt-6">
                  <Link to="/merchant/register" className="group relative px-12 py-5 bg-white dark:bg-zinc-900 text-black dark:text-white text-[12px] font-black uppercase tracking-[0.3em] overflow-hidden transition-colors duration-200 text-center">
                  ...
                  <Link to="/merchant/login" className="px-12 py-5 border border-white/20 dark:border-white/30 text-white text-[12px] font-black uppercase tracking-[0.3em] hover:bg-white dark:hover:bg-white hover:text-text-dark dark:hover:text-black transition-colors duration-200 text-center">
                    Espace Créateur
                  </Link>
                </div>
              </div>
                ...
                <div className="text-center space-y-12">
                  {[
                    ...
                    <motion.div key={stat.label} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 + (i * 0.1) }} className="space-y-1">
                      ...
                      <div className="text-[11px] text-green uppercase tracking-[0.4em] font-bold">{stat.label}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
