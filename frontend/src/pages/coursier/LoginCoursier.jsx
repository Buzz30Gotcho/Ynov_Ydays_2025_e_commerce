      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-text-dark text-white text-lg font-bold uppercase tracking-[0.2em] rounded-sm hover:bg-blue-600 transition-all duration-500 disabled:opacity-50 shadow-sm"
          >
            {loading ? (
