          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            {commonFields.map((field) => (
              <div key={field.name} className={field.name === "description" ? "md:col-span-2" : ""}>
                <label className="block text-xl uppercase tracking-widest text-text-medium font-bold mb-2">
                ...
                {errors[field.name] && (
                  <p className="text-danger text-lg mt-1 italic">{errors[field.name]}</p>
                )}
              </div>
            ))}
            ...
            {accountType === "professional" && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="md:col-span-2">
                <label className="block text-xl uppercase tracking-widest text-text-medium font-bold mb-2">Numéro SIRET</label>
                <input
                  type="text"
                  name="siret"
